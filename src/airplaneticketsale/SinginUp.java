 ...
 * @author hatice
 */
public class SinginUp extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SinginUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
